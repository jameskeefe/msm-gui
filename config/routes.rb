Rails.application.routes.draw do
  ...
  get("/directors/delete_director/:actor_id", { :controller => "directors", :action => "delete_director" })
  post("/directors/update_director/:actor_id", { :controller => "directors", :action => "update_director" })
